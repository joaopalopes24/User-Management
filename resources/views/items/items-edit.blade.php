...
<div class="col-md-12">
    <div class="box box-primary">
        ...
        <form method="post" class="needs-validation" action="{{route('items.update',$items->first()->id)}}" novalidate>
            @method('put')
            @CSRF
            <div class="box-body">
                ...
                <div class="row col-md-12">
                    <div class="col-sm-6 col-md-4 col-lg-3 form-group">
                        ...
                        <select class="form-control custom-select" name="status" id="status" required>
                            ...
                            <option value="$2y$10rH@g" <?php if($items->first()->status == '$2y$10rH@g') echo 'selected'; ?>>Ativo</option>
                            <option value=".fZEW.57&!" <?php if($items->first()->status == '.fZEW.57&!') echo 'selected'; ?>>Inativo</option>
                        </select>
                        <div class="invalid-feedback">
                            Campo Obrigatório
                        </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 form-group">
                        ...
                        <select class="form-control custom-select" name="menu" id="menu" required>
                            ...
                            @foreach ($menus as $var)
                                <option value="{{$var->id}}" <?php if($items->first()->tbl_menus_id == $var->id) echo 'selected'; ?>>{{$var->name}}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                            Campo Obrigatório
            ...
            <div class="box-footer">
                ...
                <div class="tab-content">
                    ...
                    <br>
                        <!------------------------------------------->
                        <section id="new">
                            <h4 class="page-header">Ícones Diversos</h4>
                        ...
                        <section id="web-application">
                            <h4 class="page-header">Icones de Aplicação Web</h4>
                            <div class="row fontawesome-icon-list">
                                ...
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-toggle-down"></i> fa-toggle-downspan class="text-muted">(alias)</span></div>
                        ...
                        <!------------------------------------------->
                        <section id="hand">
                            <h4 class="page-header">Ícones de Mão</h4>
                            <div class="row fontawesome-icon-list">
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hand-grab-o"></i> fa-hand-grab-o<span class="text-muted">(alias)</span></div>
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hand-lizard-o"></i> fa-hand-lizard-o</div>
                        ...
                        <section id="transportation">
                            <h4 class="page-header">Ícones de Transporte</h4>
                            <div class="row fontawesome-icon-list">
                        ...
                        <!------------------------------------------->
                        <section id="gender">
                            <h4 class="page-header">Ícones de Gênero</h4>
                            <div class="row fontawesome-icon-list">
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-genderless"></i> fa-genderless</div>
                        ...
                        <section id="file-type">
                            <h2 class="page-header">Ícones de Tipo de Arquivos</h2>
                            <div class="row fontawesome-icon-list">
                        ...
                        <!------------------------------------------->
                        <section id="spinner">
                            <h2 class="page-header">Ícones Spinner</h2>
                            <div class="row fontawesome-icon-list">
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-circle-o-notch"></i> fa-circle-o-notch</div>
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-cog"></i> fa-cog</div>
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-gear"></i> fa-gear <span class="text-muted">(alias)</span></div>
                        ...
                        <section id="form-control">
                            <h4 class="page-header">Ícones de Controle de Formulário</h4>
                            <div class="row fontawesome-icon-list">
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-check-square"></i> fa-check-square</div>
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-check-square-o"></i> fa-check-square-o</div>
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-circle"></i> fa-circle</div>
                        ...
                        <!------------------------------------------->
                        <section id="payment">
                            <h4 class="page-header">Ícones de Pagamento</h4>
                            <div class="row fontawesome-icon-list">
                        ...
                        <!------------------------------------------->
                        <section id="chart">
                            <h4 class="page-header">Ícones de Gráfico</h4>
                            <div class="row fontawesome-icon-list">
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-area-chart"></i> fa-area-chart</div>
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-bar-chart"></i> fa-bar-chart</div>
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-bar-chart-o"></i> fa-bar-chart-o<span class="text-muted">(alias)</span></div>
                        ...
                        <!------------------------------------------->
                        <section id="currency">
                            <h4 class="page-header">Ícones de Moeda</h4>
                            <div class="row fontawesome-icon-list">
                        ...
                        <section id="text-editor">
                            <h4 class="page-header">Ícones de Editor de TExto</h4>
                            <div class="row fontawesome-icon-list">
                        ...
                        <section id="directional">
                            <h4 class="page-header">Ícones Direcionais</h4>
                            <div class="row fontawesome-icon-list">
                        ...
                        <section id="video-player">
                            <h4 class="page-header">Ícones de Vídeo</h4>
                            <div class="row fontawesome-icon-list">
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-arrows-alt"></i> fa-arrows-alt</div>
                        ...
                        <!------------------------------------------->
                        <section id="brand">
                            <h4 class="page-header">Ícones de Marca</h4>
                            <div class="alert alert-info">
                                <ul class="margin-bottom-none padding-left-lg">
                                    <li>Todos os ícones de marca são marcas comerciais de seus respectivos proprietários.</li>
                                    <li>O uso dessas marcas registradas não indica endosso do titular da marca pela FontAwesome, nem vice-versa.</li>
                                </ul>
                            </div>
                            <div class="row fontawesome-icon-list">
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-500px"></i> fa-500px</div>
                        ...
                        <!------------------------------------------->
                        <section id="medical">
                            <h4 class="page-header">Ícones Médicos</h4>
                            <div class="row">
                                <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-ambulance"></i> fa-ambulance</div>
